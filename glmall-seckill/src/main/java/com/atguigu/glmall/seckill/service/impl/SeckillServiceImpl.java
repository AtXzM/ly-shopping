package com.atguigu.glmall.seckill.service.impl;
...
import com.atguigu.glmall.seckill.feign.CommoditFeignService;
import com.atguigu.glmall.seckill.feign.CouponFeignService;
import com.atguigu.glmall.seckill.interceptor.LoginUserInterceptor;
import com.atguigu.glmall.seckill.service.SeckillService;
import com.atguigu.glmall.seckill.to.SeckillSkuRedisTo;
import com.atguigu.glmall.seckill.vo.SeckillSessionWithSkusVo;
import com.atguigu.glmall.seckill.vo.SkuInfoVo;
        ...
        sessions.stream().forEach(session -> {
            ...
            session.getRelationSkus().stream().forEach(seckillSkuVo -> {
                ...
                if (!operations.hasKey(redisKey)) {
                    ...
                    R info = commoditFeignService.getSkuInfo(skuId);
                    if (info.getCode() == 0) {
