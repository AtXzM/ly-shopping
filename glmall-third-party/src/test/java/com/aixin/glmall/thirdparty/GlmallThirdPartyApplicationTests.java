package com.aixin.glmall.thirdparty;
...
//        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        ...
        // 上传文件流。
        InputStream inputStream = new FileInputStream("C:\\Users\\good luck\\Desktop\\Jq\\0001.jpg");

        ossClient.putObject("glmall-xin", "hahaha1.jpg", inputStream);
