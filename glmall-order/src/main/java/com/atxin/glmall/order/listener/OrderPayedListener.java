package com.atxin.glmall.order.listener;


import com.alipay.api.AlipayApiException;
import com.alipay.api.internal.util.AlipaySignature;
import com.atxin.glmall.order.config.AlipayTemplate;
import com.atxin.glmall.order.service.OrderService;
import com.atxin.glmall.order.vo.PayAsyncVo;
...
public class OrderPayedListener {
    ...
    public String handleAlipayed(PayAsyncVo asyncVo, HttpServletRequest request) throws AlipayApiException, UnsupportedEncodingException {
        ...
        try {
            signVerified = AlipaySignature.rsaCheckV1(params, alipayTemplate.getAlipay_public_key(),
